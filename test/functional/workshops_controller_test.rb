...
class WorkshopsControllerTest < ActionController::TestCase
  ...
  test "should create workshop" do
    assert_difference('Workshop.count') do
      post :create, workshop: { conference_id: @workshop.conference_id, content: @workshop.content, presenter: @workshop.presenter, title: @workshop.title, user_id: @workshop.user_id }
    end
  ...
  test "should update workshop" do
    put :update, id: @workshop, workshop: { conference_id: @workshop.conference_id, content: @workshop.content, presenter: @workshop.presenter, title: @workshop.title, user_id: @workshop.user_id }
    assert_redirected_to workshop_path(assigns(:workshop))
  end
